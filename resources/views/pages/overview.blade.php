    ...
    <div class="w-full flex-1 min-w-0">
        ...
        <div class="mx-auto p-3 md:p-4 bg-[#222222] rounded-[20px]">
            ...
            <div class="flex gap-4 md:gap-8 border-b border-[#2E3034] mb-4 md:mb-6 overflow-x-auto">
                <button
                    class="text-white font-semibold pb-3 border-b-2 border-[#C3CC5A] whitespace-nowrap text-sm md:text-base">Overview</button>
            ...
            <div class="bg-[#2C2C2C] px-3 md:px-4 rounded-[10px] py-3 md:py-2">
                <div class="flex items-center justify-between mb-4 md:mb-6">
                    ...
                    <button class="text-gray-400 hover:text-white text-sm md:text-base">All Matches</button>
                </div>

                <!-- Match Cards - Horizontal Scroll -->
                <div class="relative mb-6 md:mb-8">
                    <div class="flex items-center gap-2 md:gap-4 overflow-x-auto pb-2 scrollbar-hide">
                        <button class="hidden md:block flex-shrink-0 text-white hover:text-gray-400">
                            <svg class="w-5 h-5" fill="none" stroke="#C3CC5A" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7">
                                </path>
                            </svg>
                        </button>

                        <div class="flex-shrink-0 rounded-[10px] w-[260px] sm:w-[280px] md:w-[300px] p-3 bg-[#222222]">
                            <div class="flex items-center justify-between">
                                <div class="flex flex-col items-center flex-1">
                                    <img src="https://resources.premierleague.com/premierleague/badges/t8.svg"
                                        class="w-8 h-8 md:w-9 md:h-9 mb-2">
                                ...
                                <div class="flex flex-col items-center px-2">
                                    ...
                                    <span class="text-gray-400 text-xs md:text-sm">Nov 1</span>
                                </div>
                                <div class="flex flex-col items-center flex-1">
                        ...
                        <div class="flex-shrink-0 bg-[#222222] w-[260px] sm:w-[280px] md:w-[300px] p-3 rounded-[10px]">
                            <div class="flex items-center justify-between">
                                <div class="flex flex-col items-center flex-1">
                                    <img src="https://resources.premierleague.com/premierleague/badges/t8.svg"
                                        class="w-8 h-8 md:w-9 md:h-9 mb-2">
            ...
            <div class="rounded-xl overflow-hidden mt-3">
                ...
                <!-- Row 1 -->
                <div
                    class="grid grid-cols-12 gap-2 md:gap-4 px-3 md:px-6 py-4 md:py-5 bg-[#1A2039] items-center mb-3 rounded-lg hover:bg-[#222844]">
