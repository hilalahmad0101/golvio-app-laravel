...
@section('content')
    ...
    <div class="w-full flex-1 min-w-0">
        ...
        <div class=" mx-auto p-4 bg-[#222222] rounded-[20px]">
            <!-- Top Bar -->
            <div class="md:flex block md:space-y-0 space-y-2 items-center gap-3 mb-4">
                ...
                <div class="flex items-center w-full bg-[#2C2C2C]  rounded px-3">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                    <input type="text" placeholder="Search For Matches"
                        class="flex-1 bg-[#2C2C2C]  text-white px-4 py-2 text-sm placeholder-gray-500 focus:outline-none">
                </div>
            ...
            <div class="flex gap-2 mb-6 overflow-x-scroll w-full" id="time-sheet-scroll">
                ...
                <button
                    ...
                    Aug</button>
                <button
                    class="px-6 py-3 rounded-lg bg-[#2C2C2C] text-white text-xs font-medium whitespace-nowrap">Sunday<br>13
                    Aug</button>
                <button
                    class="px-6 py-3 rounded-lg bg-[#2C2C2C] text-white text-xs font-medium whitespace-nowrap">Monday<br>14
                    Aug</button>
                <button
    ...
    <x-home.right-sidebar />

    <style>
        /* Hide scrollbar for Chrome, Safari and Opera */
        #time-sheet-scroll::-webkit-scrollbar {
            display: none;
        }
